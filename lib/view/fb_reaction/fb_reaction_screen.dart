...
class FbReactionBox extends StatelessWidget {
  const FbReactionBox({Key? key}) : super(key: key);
          ...
          Container(
            child: Stack(
              children: <Widget>[
                ...
                // Icons when jump
                // Icon like
                whichIconUserChoose == 1 && !isDragging ? Container(
                ...
                // Icon love
                whichIconUserChoose == 2 && !isDragging ? Container(
                  child: Transform.scale(
                    child: Image.asset(
